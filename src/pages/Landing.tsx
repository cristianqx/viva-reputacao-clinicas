...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Hero Section */}
      <section className="py-16 lg:py-24 px-4 bg-gradient-to-br from-brand-500 to-[#322C63] text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              Receba mais avaliações no Google. Sem CRM. Sem complicação.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-primary-500 hover:bg-primary-600 text-white rounded-2xl text-lg animate-pulse-slow"
                asChild
              >
                <a href="#cadastro">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="bg-transparent text-white border-white hover:bg-white/10 rounded-2xl text-lg"
              >
                Ver demonstração
              </Button>
            </div>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl font-semibold mb-8 text-brand-500 animate-fade-in">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-12 animate-fade-in">
            {["Odonto Viva", "Sorriso Ideal", "Clínica Saúde Total", "Espaço Bem-Estar", "FisioVida"].map((name, index) => (
              <div key={index} className="bg-white p-4 rounded-lg shadow flex items-center justify-center h-24">
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-brand-500 animate-fade-in">
            Como Funciona
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-xl shadow-md text-center animate-fade-in">
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4 text-brand-500 animate-fade-in">
            Funcionalidades-Chave
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-xl shadow-md border-l-4 border-l-primary-500 animate-fade-in">
                <div className="mb-4">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold mb-2 text-brand-500">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="flex gap-4 items-start animate-fade-in">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-brand-500">{benefit.title}</h3>
      ...
      <section className="section-padding bg-gray-50" id="planos">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 max-w-3xl mx-auto p-8 animate-fade-in">
            ...
            <div className="border-t border-gray-200 py-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
            ...
            <div className="text-center mt-8">
              <Button size="lg" className="bg-primary-500 hover:bg-primary-600 text-white rounded-2xl text-lg animate-pulse-slow px-8 py-6">
      ...
      <section className="section-padding bg-brand-500 text-white" id="cadastro">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl animate-fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-primary-500 hover:bg-primary-600 rounded-xl py-6 text-lg"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
